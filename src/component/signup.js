...
export default class signup extends React.Component {
  ...
  // getData(){
  //   Geocoder.init('AIzaSyDGNzVf-e6w39OV4cJ0HSFiwPZQM8h7y5M')
  ...
  register() {
    ...
    var chooseDateTo = this.state.chooseDateTo;
    ...
    var city_code = this.state.city_code;

    const data = JSON.stringify({
        name: name,
        username : username,
        gender : gender,
        chooseDateTo : chooseDateTo,
        email : email,
        pass : password,
    ...
    if (name == '') {
        ToastAndroid.show('Enter Name', 3000)
    }
    else if (username == '') {
        ToastAndroid.show('Enter Username', 3000)
    }
    else if (gender == '') {
        ToastAndroid.show('Enter Gender', 3000)
    }
    else if (email == '') {
        ToastAndroid.show('Enter Email', 3000)
    }
    else if (password == '') {
        ToastAndroid.show('Enter Password', 3000)
    }
    else if (confirmPassword == '') {
      ToastAndroid.show('Enter Confirm Password', 3000)
  }
  else if (age == '') {
    ToastAndroid.show('Enter age', 3000)
}
    else if (fetch(ServiceConstant.signup, {
        method: 'POST',
        headers: {
        ...
        .then((responseJson) => {
            ...
            if (arr.code === 200) {
                ...
                ToastAndroid.show("User Not Added")
            }

        })) {
        ToastAndroid.show("User Successfully Added", 3000)
...
createUserModel(data) {
    ...
    user.setEmail(data.message.userDetail[0].id);

    alert("this is usermodel =>" + data)
}
